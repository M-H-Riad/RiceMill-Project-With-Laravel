...
#field{
  ...
  <body id="app">
    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div>
      	<form id="profile" method="POST" action="{{ action('equipmentCostController@update',$id) }}" style="background-color: #e6ffff">
      		{{ csrf_field() }}
                ...
                <tr>
                  ...
                  <td><input id="field" type="text" name="equipmentName" value="{{$equipmentcost->equipmentName}}" required="required"></td>
                </tr>
                <tr>
                  <td>Amount of Equipment</td>
                  <td><input id="field" type="number" step="0.01" name="equipmentAmount" value="{{$equipmentcost->equipmentAmount}}" required="required"></td>
                </tr>
                <tr>
                  <td>Total Price</td>
                  <td><input id="field" type="number" step="0.01" name="totalCost" value="{{$equipmentcost->totalCost}}" required="required"></td>
                </tr>
              {{ method_field('PUT') }}
              <tr>
