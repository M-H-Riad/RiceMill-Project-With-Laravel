...
#field{
  ...
  <body id="app">
    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div>
      	<form id="profile" method="POST" action="{{ action('foodCostController@update',$id) }}" style="background-color: #e6ffff">
      		{{ csrf_field() }}
          ...
          <tr>
            <td>Food Name</td>
            <td><input id="field" type="text" name="foodName" value="{{$foodcost->foodName}}" required="required"></td>
          </tr>
          <tr>
            <td>Amount of Food</td>
            <td><input id="field" type="number" step="0.01" name="foodAmount" value="{{$foodcost->foodAmount}}" required="required"></td>
          </tr>
          <tr>
            <td>Total Price</td>
            <td><input id="field" type="number" step="0.01" name="totalPrice" value="{{$foodcost->totalPrice}}" required="required"></td>
          </tr>
          {{ method_field('PUT') }}
          <tr>
