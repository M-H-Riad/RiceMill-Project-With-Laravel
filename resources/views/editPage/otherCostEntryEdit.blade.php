...
#field{
  ...
  <body id="app">
    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div>
      	<form id="profile" method="POST" action="{{ action('otherCostController@update',$id) }}" style="background-color: #e6ffff">
      		{{ csrf_field() }}
          <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><input id="field" type="text" name="costName" value="{{$othercost->costName}}" required="required"></td>
                </tr>
                <tr>
                  <td>Quantity of product</td>
                  <td><input id="field" type="number" step="0.01" name="productQuantity" value="{{$othercost->productQuantity}}" required="required"></td>
                </tr>
                <tr>
                  <td>Total Price</td>
                  <td><input id="field" type="number" step="0.01" name="totalCost" value="{{$othercost->totalCost}}" required="required"></td>
                </tr>
                {{ method_field('PUT') }}
                <tr>
