...
#field{
  ...
  <body id="app">
    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div>
      	<form id="profile" method="POST" action="{{ action('riceCostController@update',$id) }}" style="background-color: #e6ffff">
      		{{ csrf_field() }}
			<table class="table table-hover">
				<tr>
					<th id="entryHeader" class="text-center bg-primary" colspan="2">Rice Cost Update</th>
				</tr>
				<tr>
					<td>Rice Name</td>
					<td><input id="field" type="text" name="riceName" value="{{$ricecost->riceName}}" required="required"></td>
				</tr>
				<tr>
					<td>Rice Quality</td>
					<td><input id="field" type="text" name="riceQuality" value="{{$ricecost->riceQuality}}" required="required"></td>
				</tr>
				<tr>
					<td>Rice Quantity</td>
					<td><input id="field" type="number" step="0.01" name="riceQuantity" value="{{$ricecost->riceQuantity}}" required="required"></td>
				</tr>
				<tr>
					<td>Price Per Unit</td>
					<td><input id="field" type="number" step="0.01" name="unitPrice" value="{{$ricecost->unitPrice}}" required="required"></td>
				</tr>
				<tr>
					<td>Total Price</td>
					<td><input id="field" type="number" step="0.01" name="totalPrice" value="{{$ricecost->totalPrice}}" required="required"></td>
				</tr>
				<tr>
				...
				<tr>
					<td>Saller Name</td>
					<td><input id="field" type="text" name="sellerName" value="{{$ricecost->sellerName}}" required="required"></td>
				</tr>
				<tr>
					<td>Saller Phone</td>
					<td><input id="field" type="number" name="sellerPhone" value="{{$ricecost->sellerPhone}}" required="required"></td>
				</tr>
				<tr>
					<td>Saller Address</td>
					<td><input id="field" type="text" name="sellerAddress" value="{{$ricecost->sellerAddress}}" required="required"></td>
				</tr>
        {{ method_field('PUT') }}
				<tr>
