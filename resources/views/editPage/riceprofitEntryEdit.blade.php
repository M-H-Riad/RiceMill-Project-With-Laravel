...
#field{
  ...
  <body id="app">
    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div>
      	<form id="profile" method="POST" action="{{ action('riceProfitController@update',$id) }}" style="background-color: #e6ffff">
      		{{ csrf_field() }}
			<table class="table table-hover">
        <tr>
          <th id="entryHeader" class="text-center bg-primary" colspan="2">Rice Sell Profit Update</th>
        </tr>
        <tr>
          <td>Rice Name</td>
          <td><input id="field" type="text" name="riceName" value="{{$riceprofit->riceName}}" required="required"></td>
        </tr>
        <tr>
          <td>Rice Quality</td>
          <td><input id="field" type="text" name="riceQuality" value="{{$riceprofit->riceQuality}}" required="required"></td>
        </tr>
        <tr>
          <td>Rice Quantity</td>
          <td><input id="field" type="number" step="0.01" name="riceQuantity" value="{{$riceprofit->riceQuantity}}" required="required"></td>
        </tr>
        <tr>
          <td>Price Per Unit</td>
          <td><input id="field" type="number" step="0.01" name="unitPrice" value="{{$riceprofit->unitPrice}}" required="required"></td>
        </tr>
        <tr>
          <td>Total Price</td>
          <td><input id="field" type="number" step="0.01" name="totalPrice" value="{{$riceprofit->totalPrice}}" required="required"></td>
        </tr>
        <tr>
          <th id="subEntryHeader" class="text-center bg-secondary" colspan="2">Seller Info</th>
        </tr>
        <tr>
          <td>Customer Name</td>
          <td><input id="field" type="text" name="customerName" value="{{$riceprofit->customerName}}"required="required"></td>
        </tr>
        <tr>
          <td>Customer Phone</td>
          <td><input id="field" type="number" name="customerPhone" value="{{$riceprofit->customerPhone}}" required="required"></td>
        </tr>
        <tr>
          <td>Customer Address</td>
          <td><input id="field" type="text" name="customerAddress" value="{{$riceprofit->customerAddress}}" required="required"></td>
        </tr>
        {{ method_field('PUT') }}
				<tr>
					<td colspan="2"><input class="btn btn-primary" type="submit" name="submit" value=" Update Information "></td>
				</tr>
			</table>
		</form>
		<br><br>
