...
#field{
  ...
  <body id="app">
    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div>
      	<form id="profile" method="POST" action="{{ action('transportCostController@update',$id) }}" style="background-color: #e6ffff">
      		{{ csrf_field() }}
			   <table class="table table-hover">
              <tr>
                <th id="entryHeader" class="text-center bg-primary" colspan="2">Transport Cost Information Update</th>
              </tr>
              <tr>
                <td>Vehicle Name</td>
                <td><input id="field" type="text" name="transportName" value="{{$transportcost->transportName}}" required="required"></td>
              </tr>
              <tr>
                <td>Number of Vehicle</td>
                <td><input id="field" type="text" name="transportNumber" value="{{$transportcost->transportNumber}}" required="required"></td>
              </tr>
              <tr>
                <td>Source</td>
                <td><input id="field" type="text" name="source" value="{{$transportcost->source}}" required="required"></td>
              </tr>
              <tr>
                <td>Destination</td>
                <td><input id="field" type="text" name="destination" value="{{$transportcost->destination}}" required="required"></td>
              </tr>
              <tr>
                <td>Cost Per Vehicle</td>
                <td><input id="field" type="number" name="transportCost" value="{{$transportcost->transportCost}}" required="required"></td>
              </tr>
              {{ method_field('PUT') }}
              <tr>
                <td>Total Cost</td>
                <td><input id="field" type="number" step="0.01" name="totalCost" value="{{$transportcost->totalCost}}" required="required"></td>
              </tr>
              <tr>
