...
#field{
  ...
  <body id="app">
    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div>
      	<form id="profile" method="POST" action="{{ action('workerCostController@update',$id) }}" style="background-color: #e6ffff">
      		{{ csrf_field() }}
			<table class="table table-hover">
          <tr>
            <th id="entryHeader" class="text-center bg-primary" colspan="2">Worker Cost Information Update</th>
          </tr>
          <tr>
            <td>Number of Worker</td>
            <td><input id="field" type="number" name="numOfWorker" value="{{$workercost->numOfWorker}}" required="required"></td>
          </tr>
          <tr>
            <td>Working Hour</td>
            <td><input id="field" type="number" step="0.1" name="workingHour" value="{{$workercost->workingHour}}" required="required"></td>
          </tr>
          <tr>
            <td>Cost Per Worker</td>
            <td><input id="field" type="text" name="costPerWorker" value="{{$workercost->costPerWorker}}" required="required"></td>
          </tr>
          <tr>
            <td>Total Cost</td>
            <td><input id="field" type="number" step="0.01" name="totalCost" value="{{$workercost->totalCost}}" required="required"></td>
          </tr>
          {{ method_field('PUT') }}
          <tr>
