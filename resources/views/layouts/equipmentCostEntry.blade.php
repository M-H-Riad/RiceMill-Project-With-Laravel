...
#field{
  ...
  <body id="app">
    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div>
        <form id="profile" method="POST" action="{{url('equipmentCost')}}" style="background-color: #e6ffff">
            {{ csrf_field() }}
            <table class="table table-hover">
                <tr>
                  <th id="entryHeader" class="text-center bg-primary" colspan="2">Equipment Cost Entry</th>
                </tr>
                <tr>
                  <td>Equipment Name</td>
                  <td><input id="field" type="text" name="equipmentName" placeholder="Name Of Equipment" required="required"></td>
                </tr>
                <tr>
                  <td>Amount of Equipment</td>
                  <td><input id="field" type="number" step="0.01" name="equipmentAmount" placeholder="Equipment Amount (Unit)" required="required"></td>
                </tr>
                <tr>
                  <td>Total Price</td>
