...
#field{
  ...
  <body id="app">
    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div>
        <form id="profile" method="POST" action="{{url('foodCost')}}" style="background-color: #e6ffff">
            {{ csrf_field() }}
            <table class="table table-hover">
                <tr>
                  <th id="entryHeader" class="text-center bg-primary" colspan="2">Food Cost Entry</th>
                </tr>
                <tr>
                  <td>Food Name</td>
                  <td><input id="field" type="text" name="foodName" placeholder="Name Of Food" required="required"></td>
                </tr>
                <tr>
                  <td>Amount of Food</td>
                  <td><input id="field" type="number" step="0.01" name="foodAmount" placeholder="Food Amount (Unit)" required="required"></td>
                </tr>
                <tr>
                  <td>Total Price</td>
                  <td><input id="field" type="number" step="0.01" name="totalPrice" placeholder="total Cost" required="required"></td>
                </tr>
                <tr>
