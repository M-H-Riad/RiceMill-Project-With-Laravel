...
#field{
  ...
  <body id="app">
    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div>
        <form id="profile" method="POST" action="{{url('otherCost')}}" style="background-color: #e6ffff">
            {{ csrf_field() }}
            <table class="table table-hover">
                <tr>
                  <th id="entryHeader" class="text-center bg-primary" colspan="2">Other Cost Entry</th>
                </tr>
                <tr>
                  <td>Cost/Product Name</td>
                  <td><input id="field" type="text" name="costName" placeholder="Name Of Product" required="required"></td>
                </tr>
                <tr>
