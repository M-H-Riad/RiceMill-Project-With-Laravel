...
#field{
  ...
  <body id="app">
    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div>
        <form id="profile" method="POST" action="{{url('otherProfit')}}" style="background-color: #e6ffff">
            {{ csrf_field() }}
            <table class="table table-hover">
                <tr>
                  <th id="entryHeader" class="text-center bg-primary" colspan="2">Other Profit Entry</th>
                </tr>
                <tr>
                  <td>Product Name</td>
                  <td><input id="field" type="text" name="productName" placeholder="Name Of Product" required="required"></td>
                </tr>
                <tr>
                  <td>Quantity of product</td>
                  <td><input id="field" type="number" step="0.01" name="productQuantity" placeholder="product Amount (Unit)" required="required"></td>
                </tr>
                <tr>
                  <td>Total Price</td>
