      ...
      <div style="margin-left: 260px;margin-top: 20px;">
        ...
        <table class="table table-hover table-bordered">
            <tr>
              ...
              <th class="text-center">Profit Name</th>
              <th class="text-center">Amount</th>
              <th class="text-center">Total Profit</th>
              <th class="text-center">Action</th>
            </tr>

            @foreach($otherprofit as $row)
            <tr>
              <td>{{ $row['updated_at']}}</td>
              <td>{{ $row['productName']}}</td>
              <td>{{ $row['productQuantity']}}</td>
              <td>{{ $row['totalCost']}}</td>
              <td><a href="{{action('otherProfitController@edit',$row['id'])}}"><input class="btn btn-warning" type="button" value="Update"></a><hr>
