    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      <header class="demo-header mdl-layout__header bg-secoundary mdl-color-text--grey-600">
        ...
        <div class="demo-avatar-dropdown">
          ...
          <ul class="mdl-menu mdl-menu--bottom mdl-js-menu mdl-js-ripple-effect" for="dbtn">
            ...
            <li class="mdl-menu__item bg-secoundary"><a href="{{ url('/workerCost/create') }}">Worker Cost</a></li>
      ...
      <div class="demo-drawer mdl-layout__drawer bg-success mdl-color-text--blue-grey-50" id="rightBar">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
          ...
          <a class="mdl-navigation__link" href="{{ url('productAd/create') }}">Product Ad</a>
      ...
      <div style="margin-left: 260px;margin-top: 20px;">
        ...
        <form method="POST" action="{{ url('productAd') }}" id="input" id="form" style="background-color: #e6ffff">
               {{ csrf_field() }}
            <table class="table table-hover">
              <tr>
                <td colspan="2" class="bg-primary text-center" style="font-size: 120%;"><b>Create a New Product Advertisement</b></td>
              </tr>
              <tr>
                <td>Enter title</td>
                <td><input id="field" type="text" placeholder="Enter Product Title" name="title"></td>
              </tr>
              <tr>
                <td>Product Description</td>
                <td><input id="field" type="text" placeholder="Enter Product Description" name="description"></td>
              </tr>
              <tr>
                <td>Upload an Image </td>
                <td style="margin-left: 20px;"><input type="file" name="image"></td>
              </tr>
              <tr>
                <td colspan="2"><input class="btn btn-primary" type="submit" value="Create Advertisement"></td>
              </tr>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-danger">
        <div class="panel-heading">Name of Product and Quality</div>
        <div class="panel-body"><img src="https://placehold.it/150x80?text=IMAGE" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">Description about that Product.</div>
      </div>
      <div class="panel-footer">
        <input class="btn btn-warning" type="button" data-toggle="modal" data-target="#update" value="Update">
        <input class="btn btn-danger" type="button" data-toggle="modal" data-target="#delete" value="Delete">
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-danger">
