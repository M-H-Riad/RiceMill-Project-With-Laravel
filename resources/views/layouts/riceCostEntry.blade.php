...
#field{
  ...
  <body id="app">
    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div>
      	<form id="profile" method="POST" action="{{ url('riceCost') }}" style="background-color: #e6ffff">
      		{{ csrf_field() }}
			<table class="table table-hover">
				<tr>
					<th id="entryHeader" class="text-center bg-primary" colspan="2">Rice Cost Entry</th>
				</tr>
				<tr>
					<td>Rice Name</td>
				...
				<tr>
					<td>Saller Name</td>
					<td><input id="field" type="text" name="sellerName" placeholder="Name Of Seller" required="required"></td>
				</tr>
				<tr>
					<td>Saller Phone</td>
					<td><input id="field" type="number" name="sellerPhone" placeholder="Phone Number of Seller" required="required"></td>
				</tr>
				<tr>
					<td>Saller Address</td>
					<td><input id="field" type="text" name="sellerAddress" placeholder="Saller Address" required="required"></td>
				</tr>
				<tr>
