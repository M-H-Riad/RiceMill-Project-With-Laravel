      ...
      <div style="margin-left: 260px;margin-top: 20px;">
        ...
        <table class="table table-hover table-bordered">
            ...
            <tr>
              ...
              <td><a href="{{action('riceCostController@edit',$row['id'])}}"><input class="btn btn-warning" type="button" value="Update"></a> <hr> 
                <form method="post" action="{{ action('riceCostController@destroy',$row['id'])}}">
                    {{ csrf_field() }}
