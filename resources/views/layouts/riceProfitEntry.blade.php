...
#field{
  ...
  <body id="app">
    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div>
      	<form id="profile" method="POST" action="{{ url('riceProfit') }}" style="background-color: #e6ffff">
          {{ csrf_field() }}
      <table class="table table-hover">
        <tr>
          <th id="entryHeader" class="text-center bg-primary" colspan="2">Rice Sell Profit Entry</th>
        </tr>
        <tr>
          <td>Rice Name</td>
          <td><input id="field" type="text" name="riceName" placeholder="Name of Rice" required="required"></td>
        </tr>
        <tr>
          <td>Rice Quality</td>
          <td><input id="field" type="text" name="riceQuality" placeholder="Quality of Rice" required="required"></td>
        </tr>
        <tr>
          <td>Rice Quantity</td>
          <td><input id="field" type="number" step="0.01" name="riceQuantity" placeholder="How Many Rice?" required="required"></td>
        </tr>
        <tr>
          <td>Price Per Unit</td>
          <td><input id="field" type="number" step="0.01" name="unitPrice" placeholder="Price Per Unit" required="required"></td>
        </tr>
        <tr>
          <td>Total Price</td>
          <td><input id="field" type="number" step="0.01" name="totalPrice" placeholder="Total Price" required="required"></td>
        </tr>
        <tr>
        ...
        <tr>
          <td>Saller Name</td>
          <td><input id="field" type="text" name="customerName" placeholder="Name Of Seller" required="required"></td>
        </tr>
        <tr>
          <td>Saller Phone</td>
          <td><input id="field" type="number" name="customerPhone" placeholder="Phone Number of Seller" required="required"></td>
        </tr>
        <tr>
          <td>Saller Address</td>
          <td><input id="field" type="text" name="customerAddress" placeholder="Saller Address" required="required"></td>
        </tr>
        <tr>
