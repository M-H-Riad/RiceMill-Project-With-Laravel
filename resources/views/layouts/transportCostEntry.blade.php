...
#field{
  ...
  <body id="app">
    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div>
        <form id="profile" method="POST" action="{{url('transportCost')}}" style="background-color: #e6ffff">
            {{ csrf_field() }}
            <table class="table table-hover">
              <tr>
                <th id="entryHeader" class="text-center bg-primary" colspan="2">Transport Cost Entry</th>
              </tr>
              <tr>
                <td>Vehicle Name</td>
                <td><input id="field" type="text" name="transportName" placeholder="Name Of Vehicle" required="required"></td>
              </tr>
              <tr>
                <td>Number of Vehicle</td>
                <td><input id="field" type="text" name="transportNumber" placeholder="Number of Vehicle" required="required"></td>
              </tr>
              <tr>
                <td>Source</td>
                <td><input id="field" type="text" name="source" placeholder="From Where?" required="required"></td>
              </tr>
              <tr>
                <td>Destination</td>
                <td><input id="field" type="text" name="destination" placeholder="Where to Go?" required="required"></td>
              </tr>
              <tr>
                <td>Cost Per Vehicle</td>
                <td><input id="field" type="number" name="transportCost" placeholder="Cost Per Vehicle" required="required"></td>
              </tr>
              <tr>
                <td>Total Cost</td>
                <td><input id="field" type="number" step="0.01" name="totalCost" placeholder="Total Cost" required="required"></td>
              </tr>
              <tr>
