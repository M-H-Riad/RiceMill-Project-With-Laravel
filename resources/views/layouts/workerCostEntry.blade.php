...
#field{
  ...
  <body id="app">
    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div>
        <form id="profile" method="POST" action="{{url('workerCost')}}" style="background-color: #e6ffff">
            {{ csrf_field() }}
            <table class="table table-hover">
                <tr>
                  <th id="entryHeader" class="text-center bg-primary" colspan="2">Worker Cost Entry</th>
                </tr>
                <tr>
                  <td>Number of Worker</td>
                  <td><input id="field" type="number" name="numOfWorker" placeholder="Number Of Worker" required="required"></td>
                </tr>
                <tr>
                  <td>Working Hour</td>
                  <td><input id="field" type="number" step="0.1" name="workingHour" placeholder="Working Hour" required="required"></td>
                </tr>
                <tr>
                  <td>Cost Per Worker</td>
                  <td><input id="field" type="text" name="costPerWorker" placeholder="Cost Per Worker" required="required"></td>
                </tr>
                <tr>
                  <td>Total Cost</td>
